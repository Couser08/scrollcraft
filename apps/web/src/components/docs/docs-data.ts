...
export const DOCS_CATEGORIES: DocCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'stacked-cards', title: '<StackedCards />', badge: 'v0.2.0 Soon' },
      { id: 'text-reveal', title: '<TextReveal />', badge: 'v0.2.0 Soon' },
      { id: 'scroll-transform', title: '<ScrollTransform />', badge: 'v0.2.0 Soon' },
      { id: 'scroll-draw', title: '<ScrollDraw />', badge: 'v0.2.0 Soon' },
      { id: 'scroll-inspector', title: '<ScrollInspector />', badge: 'v0.2.0 Studio' },
    ],
  },
  {
    id: 'hooks',
    ...
    items: [
      ...
      { id: 'use-scroll-direction', title: 'useScrollDirection', badge: 'v0.2.0 Soon' },
      { id: 'use-scroll-timeline', title: 'useScrollTimeline', badge: 'v0.2.0 Soon' },
      { id: 'use-scroll-transform', title: 'useScrollTransform', badge: 'v0.2.0 Soon' },
      { id: 'use-scroll-draw', title: 'useScrollDraw', badge: 'v0.2.0 Soon' },
      { id: 'use-scroll-restoration', title: 'useScrollRestoration', badge: 'v0.2.0 Soon' },
