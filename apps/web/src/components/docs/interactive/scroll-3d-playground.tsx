      ...
      <div className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
        ...
        <div className="md:col-span-5 flex flex-col gap-4">
          <div>
            <div className="flex items-center justify-between text-xs mb-1.5">
              ...
              <span className="font-mono text-violet-400 font-semibold">{Math.round(progress * 100)}%</span>
            </div>
            <input
              type="range"
              min="0"
              ...
              className="w-full accent-violet-500 h-1.5 bg-[#E5E7EB] rounded-lg cursor-pointer"
            />
        ...
        <div className="md:col-span-7 flex flex-col gap-2">
          <div className="relative h-64 sm:h-72 rounded-xl border border-white/10 bg-gradient-to-b from-[#FAFAF9] to-white overflow-hidden flex items-center justify-center p-6 shadow-inner">
            ...
            >
              {/* Front Face */}
              <div className="w-36 h-36 rounded-2xl bg-gradient-to-br from-white to-[#FAFAF9] border-2 border-violet-500 shadow-2xl flex flex-col items-center justify-center p-4 text-center">
                <span className="p-2 rounded-xl bg-violet-500/10 text-violet-400 mb-2 shadow-xs">
